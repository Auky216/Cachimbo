export const CardInfo = ({ iconfile, title, info }) => {
  return (
    <div className="flex w-fit flex-row rounded-md border border-cach-l3 px-4 py-2 dark:border-cach-l2">
      <img src={iconfile} />
...
export const MiniCard = ({ iconfile, title }) => {
  return (
    <div className="spcing-x-2 h-fit font-bold text-cach-l5 dark:text-cach-l1">
      <img src={iconfile} />
      {title}
    </div>
  );
